...
function Features() {
  return (
    <section
      id="features"
      className="px8 xl:pt20 flex max-w-7xl flex-col gap-10 pt-10 lg:px-12 xl:m-auto"
    >
      ...
      <article className="flex w-full flex-col gap-8 overflow-hidden xl:h-96 xl:flex-row">
        <div className="md: flex flex-col gap-8 rounded-2xl bg-sky-100 px-4 sm:px-0 md:flex-row xl:w-2/3">
        ...
        <div className="flex flex-col justify-center gap-4 rounded-2xl bg-indigo-100 p-10 xl:w-1/3">
          ...
          <h2 className="text-3xl text-gray-800">Bank level Security</h2>
      ...
      <article className="flex w-full flex-col gap-8 xl:h-96 xl:flex-row">
        <div className="flex flex-col justify-center gap-4 rounded-2xl bg-orange-100 p-10 xl:w-1/3">
          ...
          <h2 className="text-3xl text-gray-800">Cost Reduction</h2>
          <p className="text-gray-500">
            Kobodrop reduced payments maintenance and processing fees. No hidden
            fees.
          </p>
        </div>
        <div className="md: flex flex-col gap-8 overflow-hidden rounded-2xl bg-sky-100 px-4 sm:px-0 md:flex-row xl:w-2/3">
          ...
          <div className="m-auto max-w-96 md:mt-36 md:w-1/2">
            <img
              src={Frames}
              alt="Frame displaying various payment solutions"
            />
          </div>
        </div>
      </article>
